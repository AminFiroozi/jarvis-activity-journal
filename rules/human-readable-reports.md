...
**Scope:** `src/journalize.py` (`render_journal`), `src/sessionize.py` (session fields consumed by it), `src/daily_summary.py`'s deterministic scaffold, and any future report renderer in this project.
